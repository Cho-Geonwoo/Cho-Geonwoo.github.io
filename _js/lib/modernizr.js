...
!(function (e, t, n) {
  ...
  function u(e, n, r, o) {
    ...
    if (parseInt(r, 10))
      for (; r--; )
        (l = s("div")), (l.id = o ? o[r] : d + (r + 1)), c.appendChild(l);
    return (
      (i = s("style")),
      (i.type = "text/css"),
      (i.id = "s" + d),
  ...
  function v(e, t, o, a) {
    ...
    for (
      var d, c, p, v, y, h = ["modernizr", "tspan", "samp"];
      !P.style && h.length;

    )
      (d = !0), (P.modElem = s(h.shift())), (P.style = P.modElem.style);
    for (p = e.length, c = 0; p > c; c++)
      if (
        ...
        if (a || r(o, "undefined")) return u(), "pfx" == t ? v : !0;
        try {
          P.style[v] = o;
        } catch (g) {}
        if (P.style[v] != y) return u(), "pfx" == t ? v : !0;
      }
    return u(), !1;
  }
  ...
  var S = [],
    x = C._config.usePrefixes
      ? " -webkit- -moz- -o- -ms- ".split(" ")
      : ["", ""];
  C._prefixes = x;
  var T = t.documentElement;
  Modernizr.addTest("classlist", "classList" in T),
  ...
  var z = "Moz O ms Webkit",
    b = C._config.usePrefixes ? z.split(" ") : [];
  C._cssomPrefixes = b;
  var A = function (t) {
    var r,
      o = x.length,
  ...
  Modernizr.addTest("requestanimationframe", !!q("requestAnimationFrame", e), {
    ...
    Modernizr.addTest("matchmedia", !!q("matchMedia", e)),
    (C.testAllProps = h),
